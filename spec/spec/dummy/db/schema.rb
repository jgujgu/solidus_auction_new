...
ActiveRecord::Schema.define(version: 20180419211577) do
  ...
  create_table "spree_auctions", force: :cascade do |t|
    ...
    t.decimal "reserve_price", precision: 12, scale: 2, default: "0.0"
    t.decimal "current_price", precision: 12, scale: 2
    t.decimal "bid_increment", precision: 12, scale: 2, default: "1.0"
    ...
    t.integer "checkout_time_minutes", default: 1440
  end
